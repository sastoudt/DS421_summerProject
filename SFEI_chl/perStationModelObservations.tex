...
\begin{itemize}
\item Overall, flow models do better than chl models (4/15 stations had lower RMSE for the chl models). 
\item D12, D22, D26, D8 have really high RMSEs for the flow model (all pretty central)
\item For the good stations, the RMSEs for the flow models are on par with the Interaction/Parsimonious Model/Full Model RMSEs. 6/15 stations have lower RMSE for the interaction model than for the flow model.

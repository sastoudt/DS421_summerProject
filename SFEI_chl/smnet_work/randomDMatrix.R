...
P=bdiag.spam(0,lambdaD*t(Dunif)%*%Dunif,lambdaT*t(temporal)%*%temporal, lambdaS*t(seasonal)%*%seasonal)
P2=bdiag.spam(0,lambdaD*t(DnormAbs)%*%DnormAbs,lambdaT*t(temporal)%*%temporal, lambdaS*t(seasonal)%*%seasonal)
...
c(rmse,rmse2,rmse3)
## 7.325734 7.359191 7.427738

## not a lot of difference

apply(tail(cbind(betaHat1,betaHat2,betaHat3)),1,sd)
##0.005103970 0.014491114 0.010253522 0.013640881 0.026848863 0.008669182 

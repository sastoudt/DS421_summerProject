...
getSummaryDifference<-function(data,index){
 ...
 rmse=sqrt(sum((predValWRTDS-predValGAM)^2,na.rm=T))
  ...
  annualRMSE1=sqrt(sum((annual1PW-annual1PG)^2,na.rm=T))
  ...
  annualRMSE2=sqrt(sum((annual2PW-annual2PG)^2,na.rm=T))
  ...
  annualRMSE3=sqrt(sum((annual3PW-annual3PG)^2,na.rm=T))
  ...
  annualRMSE4=sqrt(sum((annual4PW-annual4PG)^2,na.rm=T))
  ...
  annualRMSE5=sqrt(sum((annual5PW-annual5PG)^2,na.rm=T))
  ...
  seasonalRMSE1=sqrt(sum((seasonal1PW-seasonal1PG)^2,na.rm=T))
  ...
  seasonalRMSE2=sqrt(sum((seasonal2PW-seasonal2PG)^2,na.rm=T))
  ...
  seasonalRMSE3=sqrt(sum((seasonal3PW-seasonal3PG)^2,na.rm=T))
  ...
  seasonalRMSE4=sqrt(sum((seasonal4PW-seasonal4PG)^2,na.rm=T))
  ...
  flowRMSE1=sqrt(sum((flow1PW-flow1PG)^2,na.rm=T))
  ...
  flowRMSE2=sqrt(sum((flow2PW-flow2PG)^2,na.rm=T))
  ...
  flowRMSE3=sqrt(sum((flow3PW-flow3PG)^2,na.rm=T))
  ...
  flowRMSE4=sqrt(sum((flow4PW-flow4PG)^2,na.rm=T))

...
getSummaryRMSE_adapt2<-function(data,model){
  ...
  rmseWRTDS1=sqrt(sum((trueVal-predValWRTDS1)^2,na.rm=T))
  rmseWRTDS2=sqrt(sum((trueVal-predValWRTDS2)^2,na.rm=T))
  rmseWRTDS3=sqrt(sum((trueVal-predValWRTDS3)^2,na.rm=T))
  ...
  rmseA1W1=sqrt(sum((annual1$res-annual1PW1)^2,na.rm=T))
  rmseA2W1=sqrt(sum((annual2$res-annual2PW1)^2,na.rm=T))
  rmseA3W1=sqrt(sum((annual3$res-annual3PW1)^2,na.rm=T))
  rmseA4W1=sqrt(sum((annual4$res-annual4PW1)^2,na.rm=T))
  rmseA5W1=sqrt(sum((annual5$res-annual5PW1)^2,na.rm=T))
  
  rmseA1W2=sqrt(sum((annual1$res-annual1PW2)^2,na.rm=T))
  rmseA2W2=sqrt(sum((annual2$res-annual2PW2)^2,na.rm=T))
  rmseA3W2=sqrt(sum((annual3$res-annual3PW2)^2,na.rm=T))
  rmseA4W2=sqrt(sum((annual4$res-annual4PW2)^2,na.rm=T))
  rmseA5W2=sqrt(sum((annual5$res-annual5PW2)^2,na.rm=T))
  
  rmseA1W3=sqrt(sum((annual1$res-annual1PW3)^2,na.rm=T))
  rmseA2W3=sqrt(sum((annual2$res-annual2PW3)^2,na.rm=T))
  rmseA3W3=sqrt(sum((annual3$res-annual3PW3)^2,na.rm=T))
  rmseA4W3=sqrt(sum((annual4$res-annual4PW3)^2,na.rm=T))
  rmseA5W3=sqrt(sum((annual5$res-annual5PW3)^2,na.rm=T))
  ...
  rmseS1W1=sqrt(sum((seasonal1$res-seasonal1PW1)^2,na.rm=T))
  rmseS2W1=sqrt(sum((seasonal2$res-seasonal2PW1)^2,na.rm=T))
  rmseS3W1=sqrt(sum((seasonal3$res-seasonal3PW1)^2,na.rm=T))
  rmseS4W1=sqrt(sum((seasonal4$res-seasonal4PW1)^2,na.rm=T))
  
  rmseS1W2=sqrt(sum((seasonal1$res-seasonal1PW2)^2,na.rm=T))
  rmseS2W2=sqrt(sum((seasonal2$res-seasonal2PW2)^2,na.rm=T))
  rmseS3W2=sqrt(sum((seasonal3$res-seasonal3PW2)^2,na.rm=T))
  rmseS4W2=sqrt(sum((seasonal4$res-seasonal4PW2)^2,na.rm=T))
  
  rmseS1W3=sqrt(sum((seasonal1$res-seasonal1PW3)^2,na.rm=T))
  rmseS2W3=sqrt(sum((seasonal2$res-seasonal2PW3)^2,na.rm=T))
  rmseS3W3=sqrt(sum((seasonal3$res-seasonal3PW3)^2,na.rm=T))
  rmseS4W3=sqrt(sum((seasonal4$res-seasonal4PW3)^2,na.rm=T))
  ...
  rmseF1W1=sqrt(sum((flow1$res-flow1PW1)^2,na.rm=T))
  rmseF2W1=sqrt(sum((flow2$res-flow2PW1)^2,na.rm=T))
  rmseF3W1=sqrt(sum((flow3$res-flow3PW1)^2,na.rm=T))
  rmseF4W1=sqrt(sum((flow4$res-flow4PW1)^2,na.rm=T))
  
  rmseF1W2=sqrt(sum((flow1$res-flow1PW2)^2,na.rm=T))
  rmseF2W2=sqrt(sum((flow2$res-flow2PW2)^2,na.rm=T))
  rmseF3W2=sqrt(sum((flow3$res-flow3PW2)^2,na.rm=T))
  rmseF4W2=sqrt(sum((flow4$res-flow4PW2)^2,na.rm=T))
  
  rmseF1W3=sqrt(sum((flow1$res-flow1PW3)^2,na.rm=T))
  rmseF2W3=sqrt(sum((flow2$res-flow2PW3)^2,na.rm=T))
  rmseF3W3=sqrt(sum((flow3$res-flow3PW3)^2,na.rm=T))
  rmseF4W3=sqrt(sum((flow4$res-flow4PW3)^2,na.rm=T))
